...
class User {
    ...
    private func setupExampleTree() {
        ...
        designCell.append(cell: Cell(withMarkdownText: "### Performance\nPage transitions are sluggish. This comes from unnecessarily re-creating the NSAttributedString that the Down framwork creates after parsing markdown (see picture). This could easily be remedied (and is my next priority), but unfortunately I haven't had time to do that yet.\n\n![](https://i.imgur.com/JI2sEH8.png)"))
